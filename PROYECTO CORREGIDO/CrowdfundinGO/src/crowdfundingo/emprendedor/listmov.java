 ...
 * @author Henry Ruiz
 */
public class listmov extends javax.swing.JFrame {
    ...
    public void llenarTablaProy() throws SQLException, ClassNotFoundException {
        ...
        s.executeQuery("SELECT '$'||MONTO AS DINERO_DONADO, FECHA, reembolsado, NOMBRES||' '||APELLIDOS AS INVERSIONISTA, P.ID, TITULO FROM USUARIO U, MOVIMIENTOS M, proyecto p WHERE U.ID = M.ID_INV AND M.ID_PROYECTO=P.ID");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            Logger.getLogger(listmov.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listmov.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
