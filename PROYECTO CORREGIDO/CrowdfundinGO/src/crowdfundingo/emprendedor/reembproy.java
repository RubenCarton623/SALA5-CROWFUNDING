 ...
 * @author Henry Ruiz
 */
public class reembproy extends javax.swing.JFrame {
 ...
 */    
    public void llenarTablaProy() throws SQLException, ClassNotFoundException {
        ...
        s.executeQuery("SELECT TITULO,PAIS,m.id as ID_MOVIMIENTO,'-$'||MONTO AS DINERO_REEMBOLSADO, FECHA FROM PROYECTO P, MOVIMIENTOS M WHERE P.ID = M.ID_PROYECTO AND M.REEMBOLSADO='SI'");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            this.setTitle("Reembolsos por proyecto");
            llenarTablaProy();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(reembproy.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reembproy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
