 ...
 * @author Henry Ruiz
 */
public class listreem extends javax.swing.JFrame {
...
/**
 * Metodo llena tabla de proyecto.
 ...
 */    
    public void llenarTablaProy() throws SQLException, ClassNotFoundException {
        ...
        s.executeQuery("SELECT '$'||MONTO AS DINERO_DONADO, FECHA, NOMBRES||' '||APELLIDOS AS USUARIO FROM USUARIO U, reembolsos R WHERE U.ID_BANCUENTA = r.ID_BANCUENTA");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            this.setTitle("Reembolsos");
            llenarTablaProy();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(listreem.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listreem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
