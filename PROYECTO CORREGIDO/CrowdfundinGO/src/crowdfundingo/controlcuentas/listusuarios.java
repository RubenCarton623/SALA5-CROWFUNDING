 ...
 * @author Henry Ruiz
 */
public class listusuarios extends javax.swing.JFrame {
 ...
 */    
    public void llenarTablaProy() throws SQLException, ClassNotFoundException {
        ...
        s.executeQuery("SELECT NOMBRES, APELLIDOS, CUENTA, BANCO, TIPO FROM USUARIO U, BANCUENTA B WHERE U.ID_BANCUENTA = B.ID_BANCUENTA");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            this.setTitle("Usuarios del sistema");
            llenarTablaProy();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(listusuarios.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new listusuarios().setVisible(true);
        });
    }
